          ...
          <div className="columns">
            <div className="column">
              <div className="text-column">
                ...
                <p>Aqui eu posto algumas páginas com coisas escritas por mim. A maioria do que eu escrevo é acadêmico, então estes aparecerão como links para os artigos. As postagens (não acadêmicas), são páginas neste site.</p>
              </div>
            </div>
            <div className="column image-column">
              <Image
                src="./static/write.svg"
                width="350"
              />
            </div>
          </div>
                ...
                <a>
                  <div className="project" id={p.id}>
                    <figure className="image is-16by9">
                      <Image
                        src={"./static/essays/"+parseDate(p.date).format('YYYY')+"/"+p.id+"/icon.svg"}
                        width="150"
                      />
                    </figure>
                    <h3>{p.title}</h3>
